...
class _AccountEntryPageState extends State<AccountEntryPage> {
  ...
  Widget _buildKeyGroups(BuildContext context, ChimeraTokens tokens) {
    final normalized = normalizeAccountNumber(
      _controller.text,
    ).replaceAll('-', '');
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (_store.usesInsecureTransport) ...[
                              const SizedBox(height: 10),
                              Text(
                                'Warning: this build talks to the account service over '
                                'an unencrypted connection. Your account key and access '
                                'token can be observed by anyone on the network path.',
                                style: TextStyle(
                                  fontFamily: 'Plex Sans',
                                  fontSize: 11.5,
                                  height: 1.4,
