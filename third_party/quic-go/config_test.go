...
func configWithNonZeroNonFunctionFields(t *testing.T) *Config {
	...
	for i := 0; i < typ.NumField(); i++ {
		...
		case "GetConfigForClient", "RequireAddressValidation", "GetLogWriter", "AllowConnectionWindowIncrease", "InitialCryptoDataTracer", "InitialPacketTracer", "Tracer":
		...
		case "InitialClientHelloProfile":
			f.SetString("chrome-h3")
		...
		case "UseElasticCC":
			f.Set(reflect.ValueOf(true))
		case "ElasticCCBandwidth":
			f.Set(reflect.ValueOf(uint64(123456)))
		default:
